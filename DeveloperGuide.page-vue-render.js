...
with(this){return _c('ul',[_c('li',[_v("service staff of F&B stores that require prior bookings via customer phone calls.")]),_v(" "),_c('li',[_v("has a need to efficiently manage customer bookings, including status, timing, contact details, and past records.")]),_v(" "),_c('li',[_v("prefers an easy-to-use system for quick searching and retrieval of booking details.")]),_v(" "),_c('li',[_v("benefits from personalized service features for recognizing and managing regular customers.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": Provides a centralized system for managing customer bookings, reducing the time spent searching for reservations, and improving efficiency. Enables personalized service by tracking visit history and preferences while offering quick filtering, notifications, and daily summaries.")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("add a new booking with customer details")]),_v(" "),_c('td',[_v("keep track of upcoming reservations")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("delete a booking")]),_v(" "),_c('td',[_v("remove cancellations or incorrect entries")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("view a list of all upcoming bookings")]),_v(" "),_c('td',[_v("quickly see my schedule")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("mark a booking as completed")]),_v(" "),_c('td',[_v("keep track of which customers have visited")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("add notes to a customer profile")]),_v(" "),_c('td',[_v("remember preferences like seating choices, allergies, etc.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("search for a booking using a customer’s name or phone number")]),_v(" "),_c('td',[_v("quickly find their reservation details")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("save a new customer’s contact information")]),_v(" "),_c('td',[_v("quickly find their details for future bookings")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("edit a customer’s contact details")]),_v(" "),_c('td',[_v("update incorrect or outdated information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("delete customer contact details")]),_v(" "),_c('td',[_v("maintain an updated list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("store data offline")]),_v(" "),_c('td',[_v("keep all information for future use and tracking")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("view all upcoming bookings")]),_v(" "),_c('td',[_v("prepare for each day")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("delete all completed bookings")]),_v(" "),_c('td',[_v("clear unnecessary backlogs")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("edit an existing booking")]),_v(" "),_c('td',[_v("update details when a customer changes their reservation")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("sort bookings by date or time")]),_v(" "),_c('td',[_v("find what I need quickly")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("filter bookings by date")]),_v(" "),_c('td',[_v("see only the relevant reservations")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * ")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("view a customer’s past booking history")]),_v(" "),_c('td',[_v("provide a more personalized experience")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("view a summary of today’s bookings on the homepage")]),_v(" "),_c('td',[_v("see important details at a glance")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("receive notifications for same-day bookings")]),_v(" "),_c('td',[_v("prepare for upcoming visitors")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("automatically set reminders for upcoming bookings")]),_v(" "),_c('td',[_v("avoid forgetting customer reservations")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("see the frequency of a customer’s visits")]),_v(" "),_c('td',[_v("recognize regular customers")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("tag VIP or frequent customers")]),_v(" "),_c('td',[_v("provide them with special perks or greetings")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("save member emails for follow-up emails")]),_v(" "),_c('td',[_v("send reservation reminders and encourage repeat visits")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("flag customers with repeated no-shows")]),_v(" "),_c('td',[_v("manage bookings more effectively")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("assign specific bookings to different team members")]),_v(" "),_c('td',[_v("coordinate who is handling each customer")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("see an overview of all bookings for the week/month")]),_v(" "),_c('td',[_v("better manage the workload")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("print a list of bookings")]),_v(" "),_c('td',[_v("have a hard copy for reference")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * ")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("see the number of bookings for each day")]),_v(" "),_c('td',[_v("know how busy it will be")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("validate member emails")]),_v(" "),_c('td',[_v("ensure they are in the correct input format")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("quickly duplicate a previous booking")]),_v(" "),_c('td',[_v("save time for repeat customers")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* ")])]),_v(" "),_c('td',[_v("service staff")]),_v(" "),_c('td',[_v("view booking trends (e.g., peak hours, popular days)")]),_v(" "),_c('td',[_v("prepare for busy periods")])])])])])}
},function anonymous(
) {
...
with(this){return _c('h2',{attrs:{"id":"use-case-add-a-person"}},[_c('strong',[_v("Use Case: Add a Person")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-add-a-person","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to add a new person by entering their details (name, phone, email, address, and optional tags).")]),_v(" "),_c('li',[_v("System validates the input.")]),_v(" "),_c('li',[_v("System saves the new person to the address book.")]),_v(" "),_c('li',[_v("System displays a confirmation message:"),_c('br'),_v(" "),_c('em',[_v("\"New contact added: [person details]\"")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("1a.")]),_v(" Invalid input (e.g., empty name, bad email format).")]),_v(" "),_c('ul',[_c('li',[_v("1a1. System shows an error message: "),_c('em',[_v("\"Invalid input: [reason]\"")])]),_v(" "),_c('li',[_v("1a2. Use case resumes at step 1.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("1b.")]),_v(" Person with the same phone number already exists.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. System shows an error message: "),_c('em',[_v("\"A person with this phone number already exists.\"")])]),_v(" "),_c('li',[_v("1b2. Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('h2',{attrs:{"id":"use-case-add-a-booking"}},[_c('strong',[_v("Use Case: Add a Booking")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-add-a-booking","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to add a new booking by providing phone number, date/time, pax, optional remark, and tags.")]),_v(" "),_c('li',[_v("System checks if a person with the given phone number exists.\n"),_c('ul',[_c('li',[_v("If "),_c('strong',[_v("no")]),_v(", system shows: "),_c('em',[_v("\"No person with the given phone number exists.\"")]),_c('br'),_v("\nUse case ends.")]),_v(" "),_c('li',[_v("If "),_c('strong',[_v("yes")]),_v(", continue to step 3.")])])]),_v(" "),_c('li',[_v("System validates the booking inputs.")]),_v(" "),_c('li',[_v("System saves the booking under the person’s record.")]),_v(" "),_c('li',[_v("System displays confirmation:"),_c('br'),_v(" "),_c('em',[_v("\"New booking added: [booking details]\"")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("2a.")]),_v(" Person not found.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. System displays error.")]),_v(" "),_c('li',[_v("2a2. Use case ends.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("3a.")]),_v(" Invalid booking data (e.g., negative pax, wrong date format).")]),_v(" "),_c('ul',[_c('li',[_v("3a1. System shows relevant error message.")]),_v(" "),_c('li',[_v("3a2. Use case resumes at step 1.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("4a.")]),_v(" A booking already exists for the same date/time.")]),_v(" "),_c('ul',[_c('li',[_v("4a1. System shows: "),_c('em',[_v("\"A booking already exists for this date and time.\"")])]),_v(" "),_c('li',[_v("4a2. Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Delete Booking")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to delete a specific booking for a contact with contact number and index.")]),_v(" "),_c('li',[_v("System deletes the booking.")]),_v(" "),_c('li',[_v("System displays a confirmation message.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("1a.")]),_v(" The given contact number does not exist.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. System shows an error message: "),_c('em',[_v("\"The given contact number does not exist in our system.\"")])]),_v(" "),_c('li',[_v("1a2. Use case resumes at step 1.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("1b.")]),_v(" The given index is invalid (out of range or non-numeric).")]),_v(" "),_c('ul',[_c('li',[_v("1b1. System shows an error message: "),_c('em',[_v("\"There is no booking at the given index.\"")])]),_v(" "),_c('li',[_v("1b2. Use case resumes at step 1.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Mark Booking as Done")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to mark a specific booking as completed or cancelled with contact number and index.")]),_v(" "),_c('li',[_v("System marks the booking as completed or cancelled.")]),_v(" "),_c('li',[_v("System displays a confirmation message.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("1a.")]),_v(" The given contact number does not exist.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. System shows an error message.")]),_v(" "),_c('li',[_v("1a2. Use case resumes at step 1.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("1b.")]),_v(" The given index is invalid (out of range or non-numeric).")]),_v(" "),_c('ul',[_c('li',[_v("1b1. System shows an error message: "),_c('em',[_v("\"There is no booking at the given index.\"")])]),_v(" "),_c('li',[_v("1b2. Use case resumes at step 2.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: List Bookings")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to list bookings.")]),_v(" "),_c('li',[_v("System displays a list of bookings that are still pending.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("2a.")]),_v(" User provides the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("/all")]),_v(" flag.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. System displays all bookings, including completed or cancelled ones.")]),_v(" "),_c('li',[_v("2a2. Use case ends.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("2b.")]),_v(" There are no pending bookings.")]),_v(" "),_c('ul',[_c('li',[_v("2b1. System shows an error message.")]),_v(" "),_c('li',[_v("2b2. Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Filter")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to filter bookings by providing a phone number.")]),_v(" "),_c('li',[_v("System checks if a contact with the given phone number exists.\n"),_c('ul',[_c('li',[_v("If "),_c('strong',[_v("yes")]),_v(", proceed to step 3.")]),_v(" "),_c('li',[_v("If "),_c('strong',[_v("no")]),_v(", system shows an error message.\nUse case ends.")])])]),_v(" "),_c('li',[_v("System retrieves all bookings associated with the contact.\n"),_c('ul',[_c('li',[_v("If "),_c('strong',[_v("no bookings exist")]),_v(", system shows an error message.\nUse case ends.")])])]),_v(" "),_c('li',[_v("System displays the list of bookings for the contact.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("2a.")]),_v(" Contact does not exist.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. System shows an error message.")]),_v(" "),_c('li',[_v("2a2. Use case ends.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("3a.")]),_v(" Contact exists but has no bookings.")]),_v(" "),_c('ul',[_c('li',[_v("3a1. System shows an error message.")]),_v(" "),_c('li',[_v("3a2. Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Clear Completed Bookings")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to clear all completed or cancelled bookings.")]),_v(" "),_c('li',[_v("System deletes all bookings that are marked as completed or cancelled.\n"),_c('ul',[_c('li',[_v("2a.There are no completed bookings in the system.")]),_v(" "),_c('li',[_v("2a1. System shows an error message.")]),_v(" "),_c('li',[_v("2a2. Use case ends.")])])]),_v(" "),_c('li',[_v("System displays a confirmation message.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Exit")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, macOS")]),_v(" "),_c('li',[_c('strong',[_v("Private Contact Detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Command-Based UI")]),_v(": A user interface where actions are performed through typed commands rather than graphical elements like buttons or menus")]),_v(" "),_c('li',[_c('strong',[_v("Booking")]),_v(": A reservation entry associated with a contact, storing details such as date, time, and optional tags")]),_v(" "),_c('li',[_c('strong',[_v("Tag")]),_v(": A custom label assigned to a contact or booking to help with categorization and filtering")]),_v(" "),_c('li',[_c('strong',[_v("Index")]),_v(": A 1-based position number used to reference a booking in a contact’s list")]),_v(" "),_c('li',[_c('strong',[_v("VIP")]),_v(": A special tag or designation for important customers who may receive priority service or benefits")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Thu, 3 Apr 2025, 23:30:14 GMT+8]")])])])}
}];
