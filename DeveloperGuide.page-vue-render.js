...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Booking")]),_v(" class is a class under the Model component. It is used to represent a booking made by a customer. The class contains the following fields:")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Utilising list of integers for Ids:")]),_v(" Less space to store in the JSON file.\n"),_c('ul',[_c('li',[_v("Pros: Ensures every "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Booking")]),_v(" object is tied to a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" object.")]),_v(" "),_c('li',[_v("Cons: Fails to load JSON file if incorrectly set up.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Restaurant staff with a significant number of bookings")]),_v(" "),_c('li',[_v("needs to efficiently manage patron bookings, including status, timing, contact details, and past records")]),_v(" "),_c('li',[_v("wants to personalize services by recognizing regular patrons")]),_v(" "),_c('li',[_v("prefers desktop apps for quick searching and retrieval of booking details")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Manage patrons' information and bookings faster than a typical mouse/GUI driven app")]),_v(" "),_c('li',[_v("Accommodate patrons who need to reschedule, making for a flexible booking tool")]),_v(" "),_c('li',[_v("Track patrons' visit history and preferences for personalized services")]),_v(" "),_c('li',[_v("Summarise daily bookings to streamline shift preparation and optimize resource allocation")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("add a new booking with patron details")]),_v(" "),_c('td',[_v("keep track of upcoming reservations")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("delete a booking")]),_v(" "),_c('td',[_v("remove cancellations or incorrect entries")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("view a list of all upcoming bookings")]),_v(" "),_c('td',[_v("quickly see my schedule")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("mark a booking as completed")]),_v(" "),_c('td',[_v("keep track of which patrons have visited")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("add notes to a patron profile")]),_v(" "),_c('td',[_v("remember preferences like seating choices, allergies, etc.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("search for a booking using a patron’s name or phone number")]),_v(" "),_c('td',[_v("quickly find their reservation details")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("save a new patron’s contact information")]),_v(" "),_c('td',[_v("quickly find their details for future bookings")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("edit a patron’s contact details")]),_v(" "),_c('td',[_v("update incorrect or outdated information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("delete patron contact details")]),_v(" "),_c('td',[_v("maintain an updated list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("store data offline")]),_v(" "),_c('td',[_v("keep all information for future use and tracking")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("view all upcoming bookings")]),_v(" "),_c('td',[_v("prepare for each day")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("delete all completed bookings")]),_v(" "),_c('td',[_v("clear unnecessary backlogs")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("edit an existing booking")]),_v(" "),_c('td',[_v("update details when a patron changes their reservation")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("sort bookings by date or time")]),_v(" "),_c('td',[_v("find what I need quickly")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("filter bookings by date")]),_v(" "),_c('td',[_v("see only the relevant reservations")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * ")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("view a patron’s past booking history")]),_v(" "),_c('td',[_v("provide a more personalized experience")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("view a summary of today’s bookings on the homepage")]),_v(" "),_c('td',[_v("see important details at a glance")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("receive notifications for same-day bookings")]),_v(" "),_c('td',[_v("prepare for upcoming visitors")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("automatically set reminders for upcoming bookings")]),_v(" "),_c('td',[_v("avoid forgetting patron reservations")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("see the frequency of a patron’s visits")]),_v(" "),_c('td',[_v("recognize regular patrons")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("tag VIP or frequent patrons")]),_v(" "),_c('td',[_v("provide them with special perks or greetings")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("save member emails for follow-up emails")]),_v(" "),_c('td',[_v("send reservation reminders and encourage repeat visits")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("flag patrons with repeated no-shows")]),_v(" "),_c('td',[_v("manage bookings more effectively")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("see an overview of all bookings for the week/month")]),_v(" "),_c('td',[_v("better manage the workload")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("print a list of bookings")]),_v(" "),_c('td',[_v("have a hard copy for reference")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * ")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("see the number of bookings for each day")]),_v(" "),_c('td',[_v("know how busy it will be")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("validate member emails")]),_v(" "),_c('td',[_v("ensure they are in the correct input format")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("quickly duplicate a previous booking")]),_v(" "),_c('td',[_v("save time for repeat patrons")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("view booking trends (e.g., peak hours, popular days)")]),_v(" "),_c('td',[_v("prepare for busy periods")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("restaurant staff")]),_v(" "),_c('td',[_v("assign specific bookings to different team members")]),_v(" "),_c('td',[_v("coordinate who is handling each patron")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to add a new person by entering their details (name, phone, email, address, membership status and optional tags).")]),_v(" "),_c('li',[_v("System validates the input.")]),_v(" "),_c('li',[_v("System saves the new person to the address book.")]),_v(" "),_c('li',[_v("System displays a confirmation message:"),_c('br'),_v(" "),_c('em',[_v("\"New person added: [person details]\"")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("1a.")]),_v(" Invalid input (e.g., empty name, invalid email format, invalid phone number).")]),_v(" "),_c('ul',[_c('li',[_v("1a1. System shows error message.")]),_v(" "),_c('li',[_v("1a2. Use case resumes at step 1.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("1b.")]),_v(" Person with the same phone number already exists.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. System alerts the user that the person already exists.")]),_v(" "),_c('li',[_v("1b2. Use case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to edit an existing person by specifying their index and providing new details (name, email, address, membership status, and optional tags).")]),_v(" "),_c('li',[_v("System validates the input (ensuring no empty fields, valid email format).")]),_v(" "),_c('li',[_v("System saves the new person to the address book and notifies the user.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("1a.")]),_v(" Invalid input (e.g., empty name, invalid email format).\n"),_c('ul',[_c('li',[_v("1a1. System shows error message.")]),_v(" "),_c('li',[_v("1a2. Use case resumes at step 1.")])])]),_v(" "),_c('li',[_c('strong',[_v("1b.")]),_v(" No person found with the provided index.\n"),_c('ul',[_c('li',[_v("1b1. System shows error message.")]),_v(" "),_c('li',[_v("1b2. Use case ends.")])])]),_v(" "),_c('li',[_c('strong',[_v("1c.")]),_v(" Attempting to edit the phone number.\n"),_c('ul',[_c('li',[_v("1b1. System shows error message.")]),_v(" "),_c('li',[_v("1b2. Use case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to delete a person.")]),_v(" "),_c('li',[_v("System deletes the person from the list and notifies the user.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("1a.")]),_v(" Invalid input (e.g., invalid person id).\n"),_c('ul',[_c('li',[_v("1a1. System shows error message.")]),_v(" "),_c('li',[_v("1a2. Use case resumes at step 1.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to view a list of all persons.")]),_v(" "),_c('li',[_v("System displays the list of persons to the user.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to find a person, providing one or more search keywords.")]),_v(" "),_c('li',[_v("System displays the students that fit the search term.")]),_v(" "),_c('li',[_v("User scrolls through the displayed list to find the person they are looking for.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to add a new booking by providing phone number, date/time, pax and optional remark.")]),_v(" "),_c('li',[_v("System checks if a person with the given phone number exists.\n"),_c('ul',[_c('li',[_v("If "),_c('strong',[_v("no")]),_v(", system shows: "),_c('em',[_v("\"No person with the given phone number exists.\"")]),_c('br'),_v("\nUse case ends.")]),_v(" "),_c('li',[_v("If "),_c('strong',[_v("yes")]),_v(", continue to step 3.")])])]),_v(" "),_c('li',[_v("System validates the booking inputs.")]),_v(" "),_c('li',[_v("System saves the booking under the person’s record.")]),_v(" "),_c('li',[_v("System displays confirmation:"),_c('br'),_v(" "),_c('em',[_v("\"New booking added: [booking details]\"")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("2a.")]),_v(" Person not found.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. System displays error.")]),_v(" "),_c('li',[_v("2a2. Use case ends.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("3a.")]),_v(" Invalid booking data (e.g., negative pax, wrong date format).")]),_v(" "),_c('ul',[_c('li',[_v("3a1. System shows relevant error message.")]),_v(" "),_c('li',[_v("3a2. Use case resumes at step 1.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to edit an existing booking by specifying their index and providing new details.")]),_v(" "),_c('li',[_v("System validates the input.")]),_v(" "),_c('li',[_v("System saves the new booking to the address book and notifies the user.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("1a.")]),_v(" Invalid input (e.g., empty booking id, negative pax, wrong date format)\n"),_c('ul',[_c('li',[_v("1a1. System shows error message.")]),_v(" "),_c('li',[_v("1a2. Use case resumes at step 1.")])])]),_v(" "),_c('li',[_c('strong',[_v("1b.")]),_v(" No booking found with the provided index.\n"),_c('ul',[_c('li',[_v("1b1. System shows error message.")]),_v(" "),_c('li',[_v("1b2. Use case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to delete a booking by specifying their index.")]),_v(" "),_c('li',[_v("System deletes the booking.")]),_v(" "),_c('li',[_v("System displays a confirmation message.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("1a.")]),_v(" The given index is invalid (out of range or non-positive integer).\n"),_c('ul',[_c('li',[_v("1a1. System shows an error message.")]),_v(" "),_c('li',[_v("1a2. Use case resumes at step 1.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to mark a specific booking as upcoming, completed or cancelled with index.")]),_v(" "),_c('li',[_v("System marks the booking with the specified status.")]),_v(" "),_c('li',[_v("System displays a confirmation message.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("User requests to view a list of all bookings with status \"UPCOMING\".")]),_v(" "),_c('li',[_v("System displays a list of bookings with status \"UPCOMING\".")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("1a.")]),_v(" User provides the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("/all")]),_v(" flag.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. System displays all bookings, including completed and cancelled ones.")]),_v(" "),_c('li',[_v("1a2. Use case ends.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("2a.")]),_v(" There are no bookings with status \"UPCOMING\".")]),_v(" "),_c('ul',[_c('li',[_v("2a1. System shows an error message.")]),_v(" "),_c('li',[_v("2a2. Use case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to filter bookings by providing a phone number, booking date or booking status.")]),_v(" "),_c('li',[_v("System applies the filtering criteria (phone number and/or booking date and/or booking status).")]),_v(" "),_c('li',[_v("System retrieves all bookings associated with the filter.")]),_v(" "),_c('li',[_v("System displays the filtered list of bookings.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("2a.")]),_v(" No bookings match the filtering criteria.\n"),_c('ul',[_c('li',[_v("2a1. System shows an error message.")]),_v(" "),_c('li',[_v("2a2. Use case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to clear all completed and cancelled bookings.")]),_v(" "),_c('li',[_v("System deletes all bookings that are marked as completed or cancelled.")]),_v(" "),_c('li',[_v("System displays a confirmation message.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to clear the entire database (persons list and bookings list).")]),_v(" "),_c('li',[_v("System clears the database.")]),_v(" "),_c('li',[_v("System displays a confirmation message.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to exit the application.")]),_v(" "),_c('li',[_v("System displays a confirmation message and closes the application.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Mon, 7 Apr 2025, 17:21:34 GMT+8]")])])])}
}];
